 ...
 */
function saved_banner_related_pages() {
	...
	return apply_filters( 'saved_banner_pages', $pages_query->posts );
...
function saved_banner_data() {
	...
	// Return filtered
	return apply_filters( 'saved_banner_data', $data );

...
function saved_content_width() {
	...
	return apply_filters( 'saved_content_width', $width );
 ...
 * See saved_short_content()
 *
 * @since 1.0
 * @param array $classes Classes currently being added to body tag
 * @return array Modified classes
 */
function saved_excerpt_length( $length ) {
	return 80;
}

add_filter( 'excerpt_length', 'saved_excerpt_length', 999 );
 ...
 */
function saved_homepage_section_id_attr() {

	$GLOBALS['saved_homepage_section_i'] = isset( $GLOBALS['saved_homepage_section_i'] ) ? $GLOBALS['saved_homepage_section_i'] + 1 : 1;

	return 'id="saved-home-section-' . esc_attr( $GLOBALS['saved_homepage_section_i'] ) . '"';

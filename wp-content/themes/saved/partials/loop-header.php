...
if ( ctfw_is_posts_page() ) : ?>
	...
	<h1 id="saved-main-title"><?php saved_title_paged(); ?></h1>
		...
		<div class="saved-entry-content saved-centered-medium">
			...
			<?php if ( ! have_posts() ) : ?>
				...
				<p class="saved-no-posts-message">
					<?php printf( __( 'There are no %s to show.', 'saved' ), $taxonomy_label_lc ); ?>
				</p>
...
elseif ( is_author() ) : ?>
	...
	<h1 id="saved-main-title"><?php echo saved_title_paged(); ?></h1>
...
<?php elseif ( is_search() ) : ?>
	...
	<div class="saved-entry-content saved-centered-medium">
		...
		<p>
			...
			printf( _n( 'Your search returned %d match for %s.', 'Your search returned %d matches for %s.', $wp_query->found_posts, 'saved' ), $wp_query->found_posts, '<i>' . get_search_query() . '</i>' );
			?>
...
elseif ( is_404() ) : ?>
	...
	<h1 id="saved-main-title"><?php saved_title_paged(); // outputs Not Found ?></h1>

	<div class="saved-entry-content saved-centered-medium">
		<?php _e( 'Sorry, the page or file you tried to access was not found.', 'saved' ); ?>
	</div>

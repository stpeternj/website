...
function saved_sermon_series_after_content() {
	...
	<div id="saved-sermon-series" class="saved-sermon-index">
								...
								<div class="saved-sermon-series-dates">
									...
									if ( $series_data->sermon_earliest_date != $series_data->sermon_latest_date ) :
										...
										printf(
											...
											_x( '%s &ndash; %s', 'series date range', 'saved' ),
								...
								<div class="saved-sermon-series-count">
									...
									if ( 1 === $series_data->count ) {
										...
										printf(
											...
											_x( '%1$s %2$s', 'sermon count single', 'saved' ),
											$series_data->count,
									...
									// Multiple sermons.
										...
										printf(
											...
											_x( '%1$s %2$s', 'sermon count multiple', 'saved' ),
											$series_data->count,
											$sermon_word_plural
										);
		...
		<?php else : ?>
			...
			<p id="saved-sermon-index-none">
				<?php _e( 'There are no series to show.', 'saved' ); ?>
			</p>
...
add_action( 'saved_after_content', 'saved_sermon_series_after_content' );

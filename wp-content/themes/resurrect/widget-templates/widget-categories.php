...
$cat_args = apply_filters( 'resurrect_widget_categories_args', $cat_args );

// Show as dropdown
if ( ! empty( $instance['show_dropdown'] ) ) {

	// Add category arguments to base array
	$cat_args['show_option_none'] = _x( 'Select One', 'categories widget', 'resurrect' );
	$cat_args['id'] = 'resurrect-dropdown-taxonomy_id-' . rand( 10000, 99999 );
	$cat_args['name'] = $cat_args['id'];
	$cat_args['class'] = 'resurrect-dropdown-taxonomy-redirect';

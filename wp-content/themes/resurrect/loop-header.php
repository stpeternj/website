...
elseif ( is_tax() ) : ?>
	...
	<h1 class="resurrect-main-title"><?php resurrect_title_paged( $title ); ?></h1>
	...
	<div class="resurrect-entry-content">
		...
		<?php if ( ! have_posts() ) : ?>
			...
			<p class="resurrect-no-posts-message">
				<?php printf( __( 'There are no %s to show.', 'resurrect' ), $taxonomy_label_lc ); ?>
			</p>

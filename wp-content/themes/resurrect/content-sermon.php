					...
					<ul id="resurrect-sermon-full-buttons" class="resurrect-list-buttons">
						...
						if ( $video_download_url ) :
							?><li id="resurrect-sermon-full-video-download-button">
								<a href="<?php echo esc_url( $video_download_url ); ?>" title="<?php echo esc_attr( __( 'Download Video', 'resurrect' ) ); ?>" download>
						...
						if ( $audio_download_url ) :
							?><li id="resurrect-sermon-full-audio-download-button">
								<a href="<?php echo esc_url( $audio_download_url ); ?>" title="<?php echo esc_attr( __( 'Download Audio', 'resurrect' ) ); ?>" download>

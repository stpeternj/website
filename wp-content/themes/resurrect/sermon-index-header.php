...
$archives_meta = array(
	...
	'months' => array(
		...
		'icon'			=> 'sermon-date',
		'name'			=> _x( 'Dates', 'sermon archives', 'resurrect' ), // override
	),
);
...
<div id="resurrect-sermon-index-header">
	...
	<ul class="resurrect-list-buttons">
		...
		foreach ( $buttons as $button ) :
			...
			?><li>
				<a href="<?php echo esc_url( $button['url'] ); ?>"<?php if ( $button['selected'] ) : ?> class="resurrect-button-selected"<?php endif; ?>>
					<span class="resurrect-button-icon <?php resurrect_icon_class( $button['icon'] ); ?>"></span>

 ...
 * List page templates in order of priority for resurrect_sidebar_enabled() and ctfw_redirect_archives_to_pages().
 *
 ...
 */
function resurrect_update_content_types( $content_types ) {
...
add_filter( 'ctfw_content_types', 'resurrect_update_content_types' );

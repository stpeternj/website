 ...
 */
function resurrect_banner_related_pages() {
	...
	return apply_filters( 'resurrect_banner_pages', $pages_query->posts );
 ...
 */
function resurrect_banner_data() {
	...
	// Return filtered
	return apply_filters( 'resurrect_banner_data', $data );
